  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex w-full align-middle">
        ...
        <label
          htmlFor="rememberMe"
          className="ml-3 text-[24px] text-center font-thin"
        >
          Remember Me
        </label>
      </div>

      <Button className="w-full mt-7 h-[60px] text-[24px] bg-[#1D1A39] font-thin">
        Send 4-digit code
      </Button>
      <p className="text-center mt-3 text-[#5A5A5A] text-[20px] font-thin">
