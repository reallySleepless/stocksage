  ...
  return (
    <>
      <div className="p-2 group grid" style={{ clipPath: "inset(0 0 0 0 )" }}>
        ...
        <div className="[grid-area:1/1] flex items-center justify-center h-10 w-10 transition ease-in-out delay-30 group-hover:delay-[0s] duration-300 group-hover:translate-y-10">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
