...
export type RecentStocksCardType = {
  cLogo?: string;
  cName?: string;
  cSymbol?: string;
  cValueChange?: string;
...
const RecentStocksCard: NextPage<RecentStocksCardType> = ({
  cLogo,
  cName,
  cSymbol,
  cValueChange,
      ...
      >
        <div className="self-stretch flex flex-row items-center justify-between gap-[1.25rem]">
          ...
          <div className=" flex flex-col items-end justify-center text-right">
            <div className="relative ">{cSymbol}</div>
            <div className="relative uppercase text-[16px]" style={divStyle}>
              {cValueChange}
            </div>
          </div>
        </div>
...
export default RecentStocksCard;
