...
const LoginPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    router.push(
      `https://api.upstox.com/v2/login/authorization/dialog?response_type=code&client_id=${process.env.NEXT_PUBLIC_API_KEY}&redirect_uri=${process.env.NEXT_PUBLIC_REDIRECT_URL}`
    );
  }, []);

  return null; // This will render nothing on the login page
};
